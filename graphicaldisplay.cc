...
void GraphicalDisplay::drawSuccessScreen()
{
    ...
    drawMessage(renderer, "Success", "./fonts/Raleway-Medium.ttf", 500, color, &messageRect);
}
...
void GraphicalDisplay::drawFailureScreen()
{
    ...
    SDL_Rect messageRect = { 50, 50, 100, 100 };
    drawMessage(renderer, "Failure", "./fonts/Raleway-Medium.ttf", 500, color, &messageRect);
}
...
void GraphicalDisplay::drawGameOver()
{
    SDL_Color color = { 0, 0, 255, 255 };
    SDL_Rect messageRect = { 50, 50, 100, 100 };
    drawMessage(renderer, "You Win!", "./fonts/Raleway-Medium.ttf", 500, color, &messageRect);
}
